...
std::vector<int> SimpleAddSubWithNvtxTag(int num_elements) {
  NvtxScopedRange<XprofDomain> nvtx_range(__func__);

  std::vector<int> vec_a;
  std::vector<int> vec_b;
  std::vector<int> vec_c;
  if (NvtxScopedRange<XprofDomain> _("InitializeHostMemoryVectors"); true) {
  ...
  if (NvtxScopedRange<XprofDomain> _("Preparing"); true) {
  ...
  if (NvtxScopedRange<XprofDomain> _("Processing"); true) {
    if (NvtxScopedRange<XprofDomain> _("CopyToDevice"); true) {
    ...
    if (NvtxScopedRange<XprofDomain> _("ComputeOnDevice"); true) {
    ...
    if (NvtxScopedRange<XprofDomain> _("CopyToHost"); true) {
  ...
  if (NvtxScopedRange<XprofDomain> _("WaitResult"); true) {
